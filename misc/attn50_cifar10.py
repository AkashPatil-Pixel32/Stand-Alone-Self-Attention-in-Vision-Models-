...
def adjust_learning_rate(optimizer, lr,epochs):
...
def train(model, train_loader, lr, optimizer, criterion, epochs):
    model.train()

    train_acc = 0.0
    step = 0
    for data, target in train_loader:
        adjust_learning_rate(optimizer, lr, epochs)
...
for epoch in range(start_epoch, epochs + 1):
    train(model, train_loader,lr, optimizer, criterion, epochs)
